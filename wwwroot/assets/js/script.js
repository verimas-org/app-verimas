(function ($) {
    ...
    /*------------------------------------------
        = SUBSCRITION FORM SUBMISSION
    -------------------------------------------*/
    if ($("#sub-form-main").length) {
        $("#sub-form-main").validate({
            rules: {
                name: {
                    required: true,
                    minlength: 2
            ...
            submitHandler: function (form) {
                var formdata = new FormData(document.getElementById("sub-form-main"));
                $.ajax({
                    type: "POST",
                    data: formdata,
                    url: $(form).attr('action'),
