            ...
            <section id="company" class="row tm-section">
              <div class="col-xl-6">
                <div class="tm-section-half">
                    ...
                    <td style="">
                    1.クラウドエンジニアリング事業（クラウドインフラ構築・保守等）<br>
                    2.ソフトウェア受託開発事業<br>
                    3.SES・エンジニア派遣事業<br>
              ...
              <div class="col-xl-6">
                <div class="tm-section-half">
                    ...
                    <p class="mb-5">
                      ...
                      <B>常にテクノロジーの正体・真理を求めるのは、我が社の生き方の主要な柱の一つになりつつある。</B>
                      <hr />
                      究極のITエンジニアリング技術を求め、お客様に最適のシステム・製品を提供し、最大価値を創造する。
                      <hr />
                    </p>
                </div>
              </div>
              <div class="col-xl-6">
                <div class="tm-section-half">
                    ...
                    <hr />
                      ...
                      「究極のITエンジニアリング技術を求め、お客様に最適のシステム・製品を提供し、最大価値を創造する」という経営理念の下、私たちが提供させていただいているシステムが、より皆様の身近な存在になるべく、
